            ...
            <section className="mt-8">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-x-4 sm:gap-x-6 gap-y-3 text-sm">
                ...
                <ReportStat
                  ...
                  value={`${data.demographics.englishProficiencyScore}`}
                  precision="country"
                />
              </div>
            </section>
            ...
            {ORDER.map((section) => {
              ...
              return (
                <section key={section} className="mt-8 break-inside-avoid">
                  ...
                  <ReportSubBlock title="Country Economy Type" rows={economyTypeRows} />
                  <ReportSubBlock title="City Economy Type" rows={cityEconomyTypeRows} />

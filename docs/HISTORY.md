# Piltri - project history (archived)

> Archived 2026-09-26. Everything below describes earlier designs - live API
> aggregation, Supabase city caches, Mapbox, cron warming - that no longer
> exist. Kept for the reasoning behind product decisions. The current state
> is in HANDOFF.md.

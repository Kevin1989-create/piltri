...
export function randomCityData(city: CitySearchResult): CityExploreData {
  ...
  const data: CityExploreData = {
    ...
    climate: {
      ...
      seaLevelRiseExposure: chance(0.6) ? (pick(["High", "Moderate", "Low"]) as "High" | "Moderate" | "Low") : null,
    ...
    liveability: {
      ...
      hasBusStation: chance(0.5),
      hasSchool: chance(0.85),
      hasUniversity: chance(0.3),
      ...
      pisaMathScore: chance(0.4) ? randFloat(350, 590) : null,
      pisaReadingScore: chance(0.4) ? randFloat(350, 590) : null,
      pisaScienceScore: chance(0.4) ? randFloat(350, 590) : null,
    },

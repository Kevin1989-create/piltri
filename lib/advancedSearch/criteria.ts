...
export const CRITERIA: CriterionDef[] = [
  ...
  {
    key: "liveability.worldRankedUniversityCount",
    category: "liveability",
    label: "Ranked universities",
    unit: "count",
    kind: "range",
    suggestedRange: [0, 10],
    getCityValue: (d) => d.liveability.worldRankedUniversityCount,
  },
  {
    key: "liveability.notableRestaurantCount",
    category: "liveability",
    label: "Notable restaurants",
    unit: "count",
    kind: "range",
    suggestedRange: [0, 20],
    getCityValue: (d) => d.liveability.notableRestaurantCount,
  },
  {
